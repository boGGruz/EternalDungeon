...
class Textures_enemy(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.demon = {
            "devil_1": pg.image.load(os.path.join(material_image_path, "entity", "devil_1.png")),
            "devil_2": pg.image.load(os.path.join(material_image_path, "entity", "devil_2.png")),
            "devil_3": pg.image.load(os.path.join(material_image_path, "entity", "devil_3.png")),
            "devil_4": pg.image.load(os.path.join(material_image_path, "entity", "devil_4.png")),
            "devil_5": pg.image.load(os.path.join(material_image_path, "entity", "devil_5.png")),
            "devil_6": pg.image.load(os.path.join(material_image_path, "entity", "devil_6.png")),
            "devil_7": pg.image.load(os.path.join(material_image_path, "entity", "devil_7.png")),
            "devil_8": pg.image.load(os.path.join(material_image_path, "entity", "devil_8.png")),
            "devil_spawn_1": pg.image.load(os.path.join(material_image_path, "entity", "devil_spawn_1.png")),
            "devil_spawn_2": pg.image.load(os.path.join(material_image_path, "entity", "devil_spawn_2.png")),
            "devil_spawn_3": pg.image.load(os.path.join(material_image_path, "entity", "devil_spawn_3.png")),
            "devil_spawn_4": pg.image.load(os.path.join(material_image_path, "entity", "devil_spawn_4.png")),
            "devil_spawn_5": pg.image.load(os.path.join(material_image_path, "entity", "devil_spawn_5.png")),
        }
...
class Textures_Hud_Sound(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.sound = {
            ...
            "bite_sound": pg.mixer.Sound(os.path.join(sound_directory, "bite_sound.wav")),
        }
...
class Texture_Items(pg.sprite.Sprite):
    def __init__(self):
        ...
        self.items = {
            ...
            "hole_lock": pg.image.load(os.path.join(items_directory, "hole_lock.png")),
            "hole_lock_pickup": pg.image.load(os.path.join(items_directory, "hole_lock_pickup.png")),
            "key": pg.image.load(os.path.join(items_directory, "key.png")),
            "key_pickup": pg.image.load(os.path.join(items_directory, "key_pickup.png")),
        }
